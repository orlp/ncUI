...
for i = 1, 2 do
	...
	ncUIdb:CreatePanel(f, 24, 24, "CENTER", _G["TempEnchant"..i], "CENTER", 0, 0)	
	_G["TempEnchant"..i.."Border"]:Hide()
	_G["TempEnchant"..i.."Icon"]:SetTexCoord(.08, .92, .08, .92)
	_G["TempEnchant"..i.."Icon"]:SetPoint("TOPLEFT", _G["TempEnchant"..i], ncUIdb:Scale(2), ncUIdb:Scale(-2))
	_G["TempEnchant"..i.."Icon"]:SetPoint("BOTTOMRIGHT", _G["TempEnchant"..i], ncUIdb:Scale(-2), ncUIdb:Scale(2))
	_G["TempEnchant"..i]:SetHeight(ncUIdb:Scale(24))
