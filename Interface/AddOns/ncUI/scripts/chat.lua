...
ChatFrameEditBox:Place("TOPLEFT", ChatFrameEditBoxBackground)
ChatFrameEditBox:Place("BOTTOMRIGHT", ChatFrameEditBoxBackground)
...
local function enter()
	...
	ChatFrame3:Place("TOPRIGHT", CubeRightBG, "TOPLEFT", -10, 0)
	ChatFrame3:Place("BOTTOMLEFT", InfoRight, "TOPLEFT", 0, 10)
	ChatFrame3:Show()
	ChatFrame3Tab:Hide()
	...
	ChatFrame1:Place("TOPLEFT", CubeLeftBG, "TOPRIGHT", 8, 0)
	ChatFrame1:Place("BOTTOMRIGHT", InfoLeft, "TOPRIGHT", 0, 10)
...
local function OnHyperlinkEnter(frame, link, ...)
	...
	if linktype and linktypes[linktype] then
		...
		if frame:GetName()=="ChatFrame1" then
			GameTooltip:Place("BOTTOMLEFT", CubeLeftBG, "TOPLEFT", 0, 10)
		else
			GameTooltip:Place("BOTTOMRIGHT", CubeRightBG, "TOPRIGHT", 0, 10)
		end
